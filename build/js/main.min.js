...
/* harmony import */ var _modules_request_call_button__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/request-call-button */ "./js/modules/request-call-button.js");
/* harmony import */ var _modules_about_bottons__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/about-bottons */ "./js/modules/about-bottons.js");
/* harmony import */ var _modules_footer_mobile_nav__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/footer-mobile-nav */ "./js/modules/footer-mobile-nav.js");
...
Object(_modules_about_bottons__WEBPACK_IMPORTED_MODULE_4__["moreInfoToggle"])();
Object(_modules_footer_mobile_nav__WEBPACK_IMPORTED_MODULE_5__["handleNavigationClick"])();
Object(_modules_modal__WEBPACK_IMPORTED_MODULE_6__["toggleModal"])();
Object(_modules_request_call_button__WEBPACK_IMPORTED_MODULE_3__["leadToForm"])();
// ---------------------------------
...
/*!*************************************!*\
  !*** ./js/modules/about-bottons.js ***!
  \*************************************/
/*! exports provided: moreInfoToggle */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "moreInfoToggle", function() { return moreInfoToggle; });
// "show more" button functionality

var moreInfoButton = document.querySelector('[data-action="open-more"]');
var lessInfoButton = document.querySelector('[data-action="close-more"]');
var additionalInfo = document.querySelector('[data-target="additional-info"]');
...
/*!*****************************************!*\
  !*** ./js/modules/footer-mobile-nav.js ***!
  \*****************************************/
/*! exports provided: handleNavigationClick */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "handleNavigationClick", function() { return handleNavigationClick; });
// footer mobile navigation functionality

var footerNavContainers = document.querySelectorAll('.footer-nav');
var hideLists = function hideLists(containers, current) {
  containers.forEach(function (container) {
    if (container !== current && container.classList.contains('is-active')) {
      container.classList.remove('is-active');
      var list = container.querySelector('.footer-nav__list');
...
var handleNavigationClick = function handleNavigationClick() {
  if (window.matchMedia('(max-width: 767px)').matches) {
    footerNavContainers.forEach(function (container) {
      container.addEventListener('click', function (event) {
        if (!event.target.closest('.footer-nav__list')) {
          var current = event.currentTarget;
          var list = current.querySelector('.footer-nav__list');
...
var requestCallButton = document.querySelector('[data-action="request-call-modal"]');
var modalWindow = document.querySelector('[data-modal="feedback"]');
var closeModalButton = document.querySelector('[data-action="close-modal"]');
...
var openModal = function openModal(modal) {
  ...
  var onUploaderEscapeKeydown = function onUploaderEscapeKeydown(evt) {
    if (isEscapeKey(evt)) {
      evt.preventDefault();
      closeModal();
    }
  };
  var onOutsideModalClick = function onOutsideModalClick(evt) {
    if (modal.classList.contains('is-active') && evt.target !== modalContainer && evt.target !== requestCallButton && !modalContainer.contains(evt.target)) {
      closeModal();
    }
  };
...
var toggleModal = function toggleModal() {
  requestCallButton.addEventListener('click', function (event) {
...
/*!*******************************************!*\
  !*** ./js/modules/request-call-button.js ***!
  \*******************************************/
/*! exports provided: leadToForm */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "leadToForm", function() { return leadToForm; });
var requestCallButton = document.querySelector('[data-action="request-call"]');
var form = document.querySelector('[data-target="form"]');
var leadToForm = function leadToForm() {
