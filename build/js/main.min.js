...
var toggleNavigation = function toggleNavigation(list, title, items) {
...
var handleNavigationClick = function handleNavigationClick(event) {
  ...
  var title = target.closest('.footer-nav__title');
  if (title && footerNav.contains(title)) {
    var list = title.nextElementSibling;
    var items = list.querySelectorAll('.footer-nav__item');
